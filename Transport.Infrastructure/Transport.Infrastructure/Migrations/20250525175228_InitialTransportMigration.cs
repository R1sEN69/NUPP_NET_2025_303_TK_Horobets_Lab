...
{
    /// <inheritdoc />
    public partial class InitialTransportMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    NumberOfWagons = table.Column<int>(type: "INTEGER", nullable: false),
                    LocomotiveType = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleDrivers", x => new { x.DriversId, x.VehiclesId });
                    table.ForeignKey(
                        name: "FK_VehicleDrivers_Drivers_DriversId",
                        column: x => x.DriversId,
                        principalTable: "Drivers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VehicleDrivers_Vehicles_VehiclesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleDrivers_VehiclesId",
